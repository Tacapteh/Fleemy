  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        {/* Clients récents */}
        <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-200 dark:border-slate-700 dark:bg-slate-800 dark:text-slate-100">
          <h2 className="text-lg font-semibold text-gray-800 mb-4 flex items-center dark:text-slate-100">
            <span className="mr-2">👥</span>
            Clients récents
          </h2>
          <div className="space-y-3">
              ...
              dashboardData.recent_clients.map((client) => (
                ...
                >
                  <div>
                    ...
                    {client?.company && (
                      <p className="text-sm text-gray-600 dark:text-slate-400">{client.company}</p>
                    )}
                  </div>
          ...
          <div className="space-y-3">
            {dashboardData?.pending_quotes?.length > 0 ? (
              dashboardData.pending_quotes.map((quote) => (
                ...
                >
                  <div>
                    <p className="font-medium text-gray-800 dark:text-slate-100">{quote.title}</p>
...
const QuoteModal = ({ isOpen, onClose, onSave, quote, clients }) => {
  ...
  return (
    <div className="modal-overlay">
      <div
        className="modal-content bg-white dark:bg-slate-800 dark:text-slate-100"
        style={{ maxWidth: "800px", maxHeight: "90vh", overflowY: "auto" }}
      >
        <h2 className="modal-header dark:text-slate-100">
        ...
        <div className="form-group">
          ...
          <div className="space-y-3">
            {formData.items.map((item, index) => (
              <div key={index} className="bg-gray-50 p-4 rounded-lg dark:bg-slate-900">
                <div className="grid grid-cols-12 gap-3 items-end">
                  ...
                  <div className="col-span-2">
                    <input
                      ...
                      readOnly
                      className="form-input bg-gray-100 dark:bg-slate-900 dark:text-slate-100"
                    />
                  </div>
        ...
        <div className="bg-gray-50 p-4 rounded-lg dark:bg-slate-900">
          <div className="space-y-2 text-right">
            ...
            <div className="flex justify-between font-bold text-lg border-t border-gray-200 pt-2 dark:border-slate-700">
              <span>Total:</span>
...
const Quotes = ({ user }) => {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Quotes List */}
      <div className="bg-white rounded-xl shadow-sm border border-gray-200 dark:border-slate-700 dark:bg-slate-800 dark:text-slate-100">
        {quotes.length === 0 ? (
          <div className="p-12 text-center">
            <div className="text-6xl mb-4">📋</div>
          ...
          <div className="divide-y divide-gray-200 dark:divide-slate-700">
            {quotes.map((quote) => (
              <div
                key={quote.id}
                className="p-6 transition-all hover:bg-gray-50 dark:hover:bg-slate-900"
              >
                <div className="flex items-center justify-between">
                  <div className="flex-1">
                  ...
                  <div className="flex items-center space-x-2">
                    <button
                      ...
                      className="p-2 text-gray-400 hover:text-blue-600 hover:bg-blue-50 rounded-lg transition-all dark:text-slate-300 dark:hover:bg-blue-900/30"
                      title="Modifier"
                    >
                      ✏️
                    </button>
                    {quote.status === "sent" && (
                      <>
                        <button
                          ...
                          className="p-2 text-gray-400 hover:text-green-600 hover:bg-green-50 rounded-lg transition-all dark:text-slate-300 dark:hover:bg-emerald-900/30"
                        ...
                        <button
                          ...
                          className="p-2 text-gray-400 hover:text-red-600 hover:bg-red-50 rounded-lg transition-all dark:text-slate-300 dark:hover:bg-red-900/30"
                    ...
                    {quote.status === "accepted" && (
                      <button
                        ...
                        className="p-2 text-gray-400 hover:text-purple-600 hover:bg-purple-50 rounded-lg transition-all dark:text-slate-300 dark:hover:bg-violet-900/30"
  ...
  if (loading) {
    return (
      <div className="flex items-center justify-center h-64">
        <div className="text-center">
          <div className="animate-spin rounded-full h-12 w-12 border-b-2 border-blue-600 mx-auto mb-4"></div>
          <p className="text-gray-600 dark:text-slate-400">Chargement des factures...</p>
        </div>
      </div>
    );
  }
            ...
            {invoices.map((invoice) => (
              <div
                ...
                className={`p-6 transition-all ${
                  isOverdue(invoice)
                    ? "bg-red-50 border-l-4 border-red-400 dark:bg-red-900/30 dark:border-red-500"
